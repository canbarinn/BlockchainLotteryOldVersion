...
describe("Lock", function () {
  ...
  describe("Deployment", function () {
    ...
    it("calculateSinglePriceValue reverts", async function () {
      // COMPLETED
    ...
    it("getIthOwnedTicketNo and getLastOwnedTicketNo reverts", async function () {
    ...
    it("checkIfTicketWon and pickWinner reverts", async function () {
      // COMPLETED
      const existingTicket = 1;
      const nonExistingTicket = 5;
      const existingLotteryNumber = 1;
    ...
    it("buyTicket reverts", async function () {
      // COMPLETED
      await Lottery.connect(accounts[1]).depositEther({ value: 1 * 10 });
      ...
      await Lottery.connect(accounts[1]).depositEther({ value: 3 * 10 });
