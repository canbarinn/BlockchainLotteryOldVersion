...
describe("Lock", function () {
  ...
  describe("Deployment", function () {
    ...
    xit("buyTicket reverts", async function () {
      // COMPLETED
    ...
    xit("revealRndNumber reverts", async function () {
      // COMPLETED
      ...
      await time.increase(WEEK_IN_SECS + 1000); // increasing the time for one week in seconds
    ...
    xit("collectTicketRefund reverts", async function () {
      const nonExistingTicketNumber = 1000;
